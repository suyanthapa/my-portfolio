...
const JUST_FOR_FUN_PROJECTS: Project[] = [
  {
    ...
    icon: "cloud",
    image: "/images/projects/license-checker.png",
  },
];
        ...
        <div className="flex flex-wrap gap-3 mt-auto pt-4 border-t border-foreground/5">
          {project.github && (
            ...
            >
              ...
              {project.primaryLabel ? project.primaryLabel : "GitHub"}
            </a>
          )}
